...
This script is based on the Members_Visual.py, the visual tool used on members week.
The difference is here the style is based on CSS rather than dividing each component
to fit the screen. Much better, much general.
...
external_stylesheets = ['https://codepen.io/agarciag/pen/ZEEmeWr.css', #General CSS
                        'https://codepen.io/agarciag/pen/BaaGZzE.css'] #Particular CSS
...
app.layout=html.Div(style={'padding':'0px 20px 0px 20px','backgroundColor':colors['background']},children=[
        ...
        html.Div(className='row',children=[
          html.Div(id='left side', className='six columns', children=[           
                 html.H3(className='pretty_container', children=[
                         dcc.Markdown('**TerMITes Enviromental real time data**')],
                         style={'color':colors['text'],'textAlign':'left','fontSize':35,'backgroundColor':colors['right'],'padding':'10px 10px 10px 10px'}),
