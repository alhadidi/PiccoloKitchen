...
void loop() {
  ...
  if(up_val==LOW && d_val==HIGH){
    cabinet_up_activate();
  }
  else if(up_val==HIGH && d_val==LOW){
 ...
 */
  ...
  */
void cabinet_down() {
  motor.writeMicroseconds(1600); //Take Load off Ratchet 
  ...
  motor.writeMicroseconds(1450); //Drive the cabinet DOWN
}
